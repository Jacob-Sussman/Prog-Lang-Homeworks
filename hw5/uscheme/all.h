...
// Function to generate a record constructor name 
Name mkConstructorName(Name recname);

// Function to generate a record predicate name
Name mkPredicateName(Name recname);  

// Function to generate a record accessor name
...
Primitive arith, binary, unary, nary;
